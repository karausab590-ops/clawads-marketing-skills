...
The Foundation Doc SOP is a pre-copy research system used by 7-8 figure ecommerce brands before writing a single word of ad copy. The premise: most AI copy fails not because the AI is bad at writing â€” it fails because it has no grounding in the specific market, product, or customer.

This system produces three documents that become permanent context for every piece of copy:
1. **Research Doc** â€” Deep product and market intelligence
2. **Avatar Doc + Offer Brief** â€” Customer psychology + offer architecture
3. **Necessary Beliefs Doc** â€” The 6 belief shifts a prospect must make before buying
...
**For advertorials:** Each necessary belief = one section/argument of the advertorial.
**For email sequences:** Each email = one belief shift.
**For VSLs:** Each scene transitions from one belief to the next.
**For ads:** Hook exposes the limiting belief. Body delivers the shift. CTA offers the action.
...
- Level 5: Fully saturated. Lead with identity and personality â€” "the brand for people like you."
...
The most powerful copy doesn't introduce new ideas â€” it articulates the thoughts your prospect is *already having* but hasn't been able to put into words. When your copy does this, the reader thinks "this brand gets me" and trust builds instantly. The Avatar Doc captures this language.

**3. The Mechanism**
Prospects don't buy outcomes â€” they buy *mechanisms*. "Lose weight" is an outcome. "A 14-minute metabolic reset that forces your body into fat-burning mode before breakfast" is a mechanism. The mechanism must be specific, believable, and differentiated from everything else they've been told. The Offer Brief captures and articulates this.

---

## Step-by-Step SOP

*(Use ChatGPT 5 for all prompts â€” this system was designed for it)*

---

### PHASE 1: Research Doc

**PROMPT #1 â€” Analyze your current sales page**
...
```
â†’ Upload: PDF screenshot of your current sales page
...
**PROMPT #2 â€” Upload research methodology frameworks**
...
```
â†’ Upload: Two research methodology documents
...
**PROMPT #3 â€” Generate the Deep Research prompt**
...
â†’ Take the output prompt
â†’ Run it in OpenAI Deep Research
â†’ Save the full output â†’ this becomes your **Research Doc**
...
**PROMPT #1 â€” Avatar Doc**

The Avatar Doc is not demographics. Demographics are meaningless for copy. What matters is *psychographic state* â€” what does your customer believe, fear, want, and how do they talk about it.
...
- The specific painful situation they're in RIGHT NOW â€” not generally, but what a Tuesday looks like for them
- What they've already tried before finding my product, and why each thing failed (their explanation, not the real reason)
- Their secret fear (the thing they haven't told anyone â€” that they're afraid this will be another failure)
- Their dream outcome â€” not just the surface result but the life change that result enables
- Their #1 objection to buying â€” the specific thought that causes them to close the tab
- The exact words and phrases they use to describe their problem â€” pull these from review mining and forums
...
**PROMPT #2 â€” Offer Brief**

The Offer Brief is the strategic articulation of your offer. Its purpose is to help your AI understand what's actually being sold â€” the mechanism, transformation, and differentiation â€” so it never describes your product in generic terms.

```
Now create a clear Offer Brief for my product. Include:

1. ONE-SENTENCE PRODUCT DEFINITION â€” what it is, stripped to its core
2. THE MECHANISM â€” the specific, named, proprietary reason WHY this product works. This should be something your customer can understand and repeat to someone else
3. THE TRANSFORMATION â€” describe the "before" state and the "after" state with emotional specificity, not just surface outcomes
4. FEATURE â†’ BENEFIT TRANSLATION â€” for every feature, what does it actually mean for the customer's life
5. THE GUARANTEE â€” stated in a way that removes risk and signals confidence
6. OFFER DIFFERENTIATION â€” what makes this different from every other solution they've seen, and why those solutions failed them
...
**PROMPT #1 â€” Belief framework briefing**
...
My copy's job â€” every headline, every paragraph, every argument â€” is to 
...
**PROMPT #2 â€” Generate the Necessary Beliefs Doc**
...
Rules:
- Maximum 6 beliefs â€” these are the non-negotiables
- Structure each as: "I believe that..."
- Each belief should be written from the prospect's point of view â€” as if THEY 
  are saying it after reading your copy
- These are NOT product features or claims. These are internal states of mind.
- Each belief, if held, should make the next belief easier to accept â€” they 
...
â†’ Copy the output into its own doc: **Necessary Beliefs Doc**
...
Here are my three Foundation Docs â€” use these as your complete context:
- [Research Doc] â€” market intelligence, customer language, competitor landscape
- [Avatar Doc + Offer Brief] â€” who the customer is, what we're selling
- [Necessary Beliefs Doc] â€” the 6 belief shifts needed before purchase
...
Each argument is a *rock solid* logical case, not just a claim. The language should feel like you're building an airtight courtroom argument â€” evidence stacked on evidence, leading the reader to the only logical conclusion.
...
- [ ] Does the mechanism get named and explained â€” not just claimed?
...
- Build the Foundation Docs once â€” they power all copy for 6-12 months
...
- For agencies: build a Foundation Doc set for each client â€” the time invested upfront saves 10x in revision cycles

---

*System by Mark Builds Brands â€” adapted for AI agent use*
